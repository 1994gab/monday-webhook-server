/**
 * Sistem de coadă pentru CreditFix
 * Procesare secvențială a lead-urilor trimise către CreditFix API
 */
...
async function startProcessing() {
  ...
  while (queue.length > 0) {
    ...
    try {
      ...
      // Pauză FIX între request-uri către CreditFix (protecție API)
      ...
      failedCount++;
      console.error(`   ❌ [CREDITFIX QUEUE] Eroare: ${error.message}`);
    }
  }
