/**
 * Sistem de coadă pentru FLEX (Mediatel)
 * Procesare secvențială a lead-urilor trimise către Mediatel API
 */

// Configurare delay FIX între lead-uri (în secunde)
const DELAY_SECONDS = 2;  // Fix 2 secunde între lead-uri
...
async function startProcessing() {
  ...
  while (queue.length > 0) {
    ...
    try {
      ...
      // Pauză FIX între request-uri către Mediatel (protecție API)
      ...
      failedCount++;
      console.error(`   ❌ [FLEX QUEUE] Eroare: ${error.message}`);
    }
  }
