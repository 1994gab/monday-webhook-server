/**
 * Sistem de coadă pentru iCredit
 * Procesare secvențială a lead-urilor trimise către iCredit API
 */
...
async function startProcessing() {
  ...
  while (queue.length > 0) {
    ...
    try {
      ...
      // Pauză FIX între request-uri către iCredit (protecție API)
      ...
      failedCount++;
      console.error(`   ❌ [ICREDIT QUEUE] Eroare: ${error.message}`);
    }
  }
