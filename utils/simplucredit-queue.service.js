/**
 * Sistem de coadă pentru Simplu Credit
 * Procesare secvențială a lead-urilor trimise către Simplu Credit API
 */

// Configurare delay între lead-uri (în secunde)
const DELAY_SECONDS = 2;  // 2 secunde între lead-uri
...
async function startProcessing() {
  ...
  while (queue.length > 0) {
    ...
    try {
      ...
      // Pauză între request-uri (protecție API)
      ...
      failedCount++;
      console.error(`   ❌ [SIMPLU QUEUE] Eroare: ${error.message}`);
    }
  }
